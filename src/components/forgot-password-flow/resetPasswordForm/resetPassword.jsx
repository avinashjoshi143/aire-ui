...
const ResetPasswordForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="password" name="newPassword" value={newPassword} onChange={handleChange} placeholder="New Password" required />
            ...
            <button type="submit" disabled={loading}>Create New Password</button>
        </form>
    );
};
